...
const string RegularExpressionSources::positiveDecimal     = naturalNumber + "\\." + naturalNumber;
const string RegularExpressionSources::positivePointNumber = "\\." + naturalNumber;

const string RegularExpressionSources::number =
    "-?" + Bracket( Or( naturalNumber, positiveDecimal, positivePointNumber ) );

const string RegularExpressionSources::numberWithUnit = Capture( number ) + ignoreWhitespace + Capture( unit );

// Control Signals
const string RegularExpressionSources::controlSequenceTempoInstruction = numberWithUnit + ":";
const string RegularExpressionSources::controlSequenceValueInstruction = numberWithUnit;
...
const string RegularExpressionSources::controlSequenceInstruction      = Or( controlSequenceTempoInstruction,
                                                                        controlSequenceValueInstruction,
                                                                        controlSequenceGlideInstruction,
                                                                        controlSequenceRestInstruction );
